...
namespace Blog.Data.Mappings
{
    public class UserMap : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            //HasOne<Role>().WithMany() é usado para definir a relação entre a entidade "UserRole" e "Role" no modelo.
            //Isso significa que a entidade "UserRole" possui uma "Role" e "Role" possui muitos "UserRole".
        }
    }
}